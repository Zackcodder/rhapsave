...
// For second method
  ...
  //   print(config.loginHint);
  //   print(config.authorizationUrl);
  //   print(config.redirectUri);
  //   print(config.isB2C);
  //   print(config.responseType);
  //   print(config.tenant);
  //   print(config.loader);
  ...
  //       Uri.parse('https://mobile.nubiaville.com'),
  //       // body: jsonEncode({
  //       //   "identity": email,
  //       //   "password": password,
  //       // }),
  ...
  // try {
  //   if (response.statusCode == 200) {
  //     var accessToken = json.decode(response.body)['access token'];
  //     print(response.body);
  //     print(email);
  //     print(accessToken);
  ...
  //     if (data['status'] == 200) {
  //       sharedPreferences.setString('token', accessToken.toString());
  ...
  static const String CLIENT_ID = '906cfb22-37b0-47b1-a15c-3b42a60460e8';
